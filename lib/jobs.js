...
export function buildBatchSummaryMessage(jobs, batchLabelDate, jobsTabUri) {
  const header = `🏉🏉 ${formatBatchLabelDate(batchLabelDate)} 🏉🏉`;
    ...
    contents: {
      ...
      body: {
        ...
        contents: [
          ...
          ...highlight(
            "✋ ก่อนเริ่มใช้งาน",
            "ทุกคนในกลุ่มพิมพ์อะไรก็ได้สักครั้ง (เช่น สวัสดี) เพื่อให้ระบบรู้จักว่าอยู่กลุ่มนี้ ไม่งั้นจะยังไม่เห็นกลุ่มนี้ในหน้าโพสต์งาน/รับงาน"
          ),

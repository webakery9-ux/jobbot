...
export function buildWelcomeMessage(guideUrl, addFriendUrl) {
  ...
  const footerButtons = [
    ...(addFriendUrl
      ? [{ type: "button", style: "primary", action: { type: "uri", label: "➕ เพิ่มเพื่อน JobBotTH", uri: addFriendUrl } }]
      : []),
    ...(guideUrl
      ? [{ type: "button", style: "secondary", action: { type: "uri", label: "📖 ดูวิธีใช้งานแบบละเอียด", uri: guideUrl } }]
      : []),
  ];
        ...
        contents: [
          ...
          ...highlight(
            ...
            "กรุณาเพิ่มเพื่อน JobBotTH ก่อน เพื่อรับงาน หลังจากเพิ่มเพื่อนเสร็จแล้ว กลับมาพิมพ์อะไรก็ได้ในกลุ่มนี้อีกครั้ง " +
              'เช่น พิมพ์ว่า "พร้อมรับงาน" เพื่อแจ้งให้บอททราบว่ารับงานกลุ่มนี้ หลังจากนั้นจะกลับไปดูรายละเอียดงานในแชทส่วนตัวได้เลยครับ'
          ),
          ...highlight("⚡ รับงานไว ไม่ต้องโทรอีกต่อไป", 'กดปุ่ม "รับงาน" บนการ์ด ใครกดก่อนได้งานก่อนทันที'),
          ...highlight(
            "📝 โพสต์งานได้จากหน้าระบบ",
            "เปิดหน้าโพสต์งานในแชทส่วนตัว เลือกกลุ่มที่จะส่งได้เอง โพสต์ได้ทั้งทีละงานหรือหลายงานพร้อมกัน"
          ),
          ...highlight(

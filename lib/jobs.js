  ...
  const bodyContents = [
    ...
    { type: "text", text: job.detail, wrap: true, margin: "md", size: "md" },
    {
      ...
      contents: [
        ...
        { type: "text", text: `การจ่ายเงิน: ${job.payment_method}`, size: "sm" },
    ...
    },
    {
      ...
      margin: "lg",
      contents: [
        { type: "text", text: `ใช้เครดิตไป: ${claim.platform_fee}`, size: "sm" },
        {
          type: "text",
...
export function buildJobPostedCard(job, balance, extraNote) {
  ...
  const creditBoxContents = [
    { type: "text", text: `ใช้เครดิตไป: ${job.platform_fee}`, size: "sm" },
    {
      type: "text",
      text: `เครดิตคงเหลือ: ${balance}`,
      size: "sm",
